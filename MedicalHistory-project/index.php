            ...
            <div class="navbar navbar-expand">
                ...
                <div class="navbarButtons me-sm-5 ms-sm-5">
                    <ul class="navbar-nav mr-auto">
                        <a href="registration.php"><button type="button" class="btn btn-primary btn-sm ps-3 pe-3 me-sm-2 buttonsNav">Crear cuenta</button></a>
                        <a href="chooseLogin.php"><button type="button" class="btn btn-primary btn-sm ps-3 pe-3 ms-sm-2 buttonsNav">Iniciar sesion</button></a>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="container-fluid pt-5 firstPresentation">
            <div class="row justify-content-around pb-5 pt-5">
                <div class="col-md-5 order-2 order-sm-first align-self-center text-center text-sm-start pt-4">
                    ...
                    <a href="registration.php"><button type="button" class="btn btn-primary btn-sm ps-5 pe-5">Crear cuenta</button></a>
                </div>
        ...
        <div class="container-fluid pt-3 pb-3 mt-3 mb-3 footer" style="background-color: #edf0f4;" id="contacto">
            <div class="row justify-content-center pt-5">
                ...
                <div class="col-md-3 order-2 order-sm-2 align-self-center text-center text-sm-start pt-sm-2 pb-sm-2">
                    <a href="chooseLogin.php"><button type="button" class="btn btn-primary btn-sm ps-4 pe-4 ms-sm-3">Iniciar sesión</button></a>
                    <a href="registration.php"><button type="button" class="btn btn-primary btn-sm ps-4 pe-4 ms-sm-3">Crear cuenta</button></a>
                </div>
